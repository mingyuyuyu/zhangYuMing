	...
	_init:function(options){
		...
		smallImg.onload = ()=>{
			...
			if(opt.position === 'right'){
				big.style.left = this.ele.offsetLeft + smallImg.offsetWidth + opt.gap +20+ 'px';
				big.style.top = this.ele.offsetTop-20+ 'px';
			...
			this.ele.style.width = smallImg.offsetWidth + 'px';
		}
